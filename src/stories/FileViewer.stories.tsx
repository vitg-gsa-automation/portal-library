...
export const JSONOutput: Story<FileViewerProps> = (args) => {
  const json = {
    PkgName: 'ChatPackage',
    PkgDesc: 'ATO Package for Chat Cloud Service',
    SystemIdentifier: 'MS1000201',
    SystemName: 'MicrosoftTeamsSystem',
    DocObjectId: 655,
    DocShortName: 'ssp',
    DocFullName: 'Microsoft-System',
    DocTypeAbbrev: 'SSP',
    DocumentDescription: 'OSCAL SYSTEM SECURITY PLAN',
    DocStatus: 'Pending Review',
    FileLink:
      'http://filestore.volpegroup.com/DataStore/1F1FBEE3-224D-4D28-94BA-71F71F82BD8F.xml',
    DocOjectCreatedDate: '2023-03-01T16:12:07.03',
    DocObjectCreatedby: 5,
    DocObjectModifiedDate: '2023-06-26T09:59:23.573',
    DocObjectModifiedBy: 13,
    FileName: 'MicrosoftSSP1.xml',
    FileIdentifier: '1f1fbee3-224d-4d28-94ba-71f71f82bd8f',
    FileUploadTypeID: 1,
    FileUploadType: 'OSCAL XML',
    FileSize: 27304,
    SystemID: 140,
    SystemName1: 'MicrosoftTeamsSystem',
    UserID: 5,
    User: 'Aaron Nolan',
    UploadDate: '2023-06-26T09:59:23.563',
    OrgID: '49e25db3-91f0-4ed1-80d0-effaeb661865',
    OrgName: 'Microsoft Corporation',
  };
  const html = useHighlight(JSON.stringify(json), 'json');
  return (
    <React.Fragment>
      <FileViewer {...args} html={html || ''} />
    </React.Fragment>
...
export const InModal: Story<FileViewerProps> = (args) => {
  const svrl: SVRL = {
  ...
  `;
  const { html, activateById, activateByIndex } = useAnnotations({
    fileString,
    annotations,
    SaxonJS,
  });
